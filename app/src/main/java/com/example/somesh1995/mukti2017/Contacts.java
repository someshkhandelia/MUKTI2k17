...
public class Contacts extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            getFragmentManager()
                    .beginTransaction()
                    .add(R.id.cl1, new Card1FrontFragment())
                    .commit();
            getFragmentManager()
                    .beginTransaction()
                    .add(R.id.cl2, new Card2FrontFragment())
                    .commit();
            getFragmentManager()
                    .beginTransaction()
                    .add(R.id.cl3, new Card3FrontFragment())
                    .commit();
            getFragmentManager()
                    .beginTransaction()
                    .add(R.id.cl4, new Card4FrontFragment())
                    .commit();
        } else {
        ...
        f1=(LinearLayout)findViewById(R.id.cl1);
        f2=(LinearLayout)findViewById(R.id.cl2);
        f3=(LinearLayout)findViewById(R.id.cl3);
        f4=(LinearLayout)findViewById(R.id.cl4);
    ...
    public void flipCard1() {
        ...
        getFragmentManager()
                ...
                // variable).
                .replace(R.id.cl1, new Card1BackFragment())
    ...
    public void flipCard2() {
        ...
        getFragmentManager()
                ...
                // representing the next page (indicated by the just-incremented currentPage
                // variable).
                .replace(R.id.cl2, new Card2BackFragment())
    ...
    public void flipCard3() {
      ...
      /*  if(mShowingBack2){
        ...
        getFragmentManager()
                ...
                // representing the next page (indicated by the just-incremented currentPage
                // variable).
                .replace(R.id.cl3, new Card3BackFragment())
    ...
    public void flipCard4() {
       ...
       /* if(mShowingBack2){
        ...
        getFragmentManager()
                ...
                // representing the next page (indicated by the just-incremented currentPage
                // variable).
                .replace(R.id.cl4, new Card4BackFragment())
    ...
    public static class Card1FrontFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            return inflater.inflate(R.layout.fragment_card11_front, container, false);
        }
    ...
    public static class Card2FrontFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            return inflater.inflate(R.layout.fragment_card12_front, container, false);
        }
    ...
    public static class Card3FrontFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            return inflater.inflate(R.layout.fragment_card13_front, container, false);
        }
    ...
    public static class Card4FrontFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            return inflater.inflate(R.layout.fragment_card14_front, container, false);
        }
    ...
    public static class Card1BackFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            return inflater.inflate(R.layout.fragment_card11_back, container, false);
        }
    }
    /**
    ...
    public static class Card2BackFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            return inflater.inflate(R.layout.fragment_card12_back, container, false);
        }
    }
    /**
    ...
    public static class Card3BackFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            return inflater.inflate(R.layout.fragment_card13_back, container, false);
        }
    }
    /**
    ...
    public static class Card4BackFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            return inflater.inflate(R.layout.fragment_card14_back, container, false);
        }
    }
}
