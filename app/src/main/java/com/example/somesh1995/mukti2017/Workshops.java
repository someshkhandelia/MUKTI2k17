...
public class Workshops extends Activity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            getFragmentManager()
                    .beginTransaction()
                    .add(R.id.wl1, new Card1FrontFragment())
                    .commit();
            getFragmentManager()
                    .beginTransaction()
                    .add(R.id.wl2, new Card2FrontFragment())
                    .commit();
            getFragmentManager()
                    .beginTransaction()
                    .add(R.id.wl3, new Card3FrontFragment())
                    .commit();
            getFragmentManager()
                    .beginTransaction()
                    .add(R.id.wl4, new Card4FrontFragment())
                    .commit();
        } else {
        ...
        f1=(LinearLayout)findViewById(R.id.wl1);
        f2=(LinearLayout)findViewById(R.id.wl2);
        f3=(LinearLayout)findViewById(R.id.wl3);
        f4=(LinearLayout)findViewById(R.id.wl4);
    ...
    public void flipCard1() {
        ...
        getFragmentManager()
                ...
                // variable).
                .replace(R.id.wl1, new Card1BackFragment())
    ...
    public void flipCard2() {
        ...
        getFragmentManager()
                ...
                // representing the next page (indicated by the just-incremented currentPage
                // variable).
                .replace(R.id.wl2, new Card2BackFragment())
    ...
    public void flipCard3() {
      ...
      /*  if(mShowingBack2){
        ...
        getFragmentManager()
                ...
                // representing the next page (indicated by the just-incremented currentPage
                // variable).
                .replace(R.id.wl3, new Card3BackFragment())
    ...
    public void flipCard4() {
       ...
       /* if(mShowingBack2){
        ...
        getFragmentManager()
                ...
                // representing the next page (indicated by the just-incremented currentPage
                // variable).
                .replace(R.id.wl4, new Card4BackFragment())
    ...
    public static class Card1FrontFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            return inflater.inflate(R.layout.fragment_card15_front, container, false);
        }
    ...
    public static class Card2FrontFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            return inflater.inflate(R.layout.fragment_card16_front, container, false);
        }
    ...
    public static class Card3FrontFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            return inflater.inflate(R.layout.fragment_card17_front, container, false);
        }
    ...
    public static class Card4FrontFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            return inflater.inflate(R.layout.fragment_card18_front, container, false);
        }
    ...
    public static class Card1BackFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            return inflater.inflate(R.layout.fragment_card15_back, container, false);
        }
    }
    /**
    ...
    public static class Card2BackFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            return inflater.inflate(R.layout.fragment_card16_back, container, false);
        }
    }
    /**
    ...
    public static class Card3BackFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            return inflater.inflate(R.layout.fragment_card17_back, container, false);
        }
    }
    /**
    ...
    public static class Card4BackFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            return inflater.inflate(R.layout.fragment_card18_back, container, false);
        }
    }
}
